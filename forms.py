...
class VenueForm(Form):
    name = StringField(
        'name', validators=[DataRequired(message='Venue Name Required')]
    )
    city = StringField(
        'city', validators=[DataRequired(message='City Name Required')]
    )
    state = SelectField(
    ...
    phone = StringField(
        'phone', validators=[DataRequired(message='Phone is Required')]
    )
...
class ArtistForm(Form):
    ...
    website = StringField(
        'website', default=None, validators=[Optional(), URL()]
    )
